    ...
    public function column_delivery_date(\WC_Order $order): string
    {
        ...
        try {
            ...
            if ($date < $today) {
                ...
                $badge = '<span class="marwchto-date-badge past">' . esc_html__('Past', 'marwen-checkout-toolkit-for-woocommerce') . '</span>';
            } elseif ($date->format('Y-m-d') === $today->format('Y-m-d')) {
                $class = 'marwchto-date-today';
                $badge = '<span class="marwchto-date-badge today">' . esc_html__('Today', 'marwen-checkout-toolkit-for-woocommerce') . '</span>';
            } elseif ($date->format('Y-m-d') === $tomorrow->format('Y-m-d')) {
                $class = 'marwchto-date-tomorrow';
                $badge = '<span class="marwchto-date-badge tomorrow">' . esc_html__('Tomorrow', 'marwen-checkout-toolkit-for-woocommerce') . '</span>';
            }
