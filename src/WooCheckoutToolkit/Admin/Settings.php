...
class Settings
{
    ...
    public function add_menu_page(): void
    {
        add_submenu_page(
            'woocommerce',
            __('Checkout Toolkit', 'marwen-marwchto-for-woocommerce'),
            __('Checkout Toolkit', 'marwen-marwchto-for-woocommerce'),
            'manage_woocommerce',
            'marwchto-settings',
    ...
    {
        return [
            'woocommerce_before_checkout_billing_form' => __('Before billing fields', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_after_checkout_billing_form' => __('After billing fields', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_before_checkout_shipping_form' => __('Before shipping fields', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_after_checkout_shipping_form' => __('After shipping fields', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_before_order_notes' => __('Before order notes', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_after_order_notes' => __('After order notes', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_review_order_before_cart_contents' => __('Before order review', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_review_order_after_cart_contents' => __('After order review items', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_review_order_before_shipping' => __('Before shipping in review', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_review_order_after_shipping' => __('After shipping in review', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_review_order_before_order_total' => __('Before order total', 'marwen-marwchto-for-woocommerce'),
            'woocommerce_review_order_before_submit' => __('Before Place Order button', 'marwen-marwchto-for-woocommerce'),
        ];
    }
