                        ...
                        <div class="marwchto-locations-list">
                            ...
                            <div class="marwchto-location-row">
                                <div class="marwchto-location-header">
                                    <h4><?php esc_html_e('Location', 'marwen-checkout-toolkit-for-woocommerce'); ?> <span class="marwchto-location-number"><?php echo esc_html($marwchto_index + 1); ?></span></h4>
                                    <a href="#" class="button-link-delete marwchto-remove-location" title="<?php esc_attr_e('Remove location', 'marwen-checkout-toolkit-for-woocommerce'); ?>">
