...
<div class="wct-settings-section">
    ...
    <table class="form-table wct-settings-table">
        ...
        <tbody id="wct-sl-options" class="<?php echo empty($marwchto_store_locations_settings['enabled']) ? 'wct-field-options-disabled' : ''; ?>">
            <!-- Required -->
            <tr>
                <th scope="row">
                        ...
                        <div class="wct-locations-list">
                            ...
                            <div class="wct-location-row">
                                <div class="wct-location-header">
                                    <h4><?php esc_html_e('Location', 'marwen-checkout-toolkit-for-woocommerce'); ?> <span class="wct-location-number"><?php echo esc_html($marwchto_index + 1); ?></span></h4>
